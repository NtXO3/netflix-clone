                ...
                <div className='w-full h-[550px] text-white relative' id={'selected-movie' + rowId} style={{maxHeight: 0, transition: 'all 300ms ease', overflow: 'hidden'}}>
                    <div className="w-full h-full" id={selectedMovie.movieInfo?.id}>
                        ...
                        <div className='absolute w-full top-[20%] p-4 md:p-8'>
                            ...
                            <div className='my-4'>
                                <button className='border bg-gray-300 text-black border-gray-300 py-2 px-5 no-cursor'>Play</button>
                                <button className='border text-white border-gray-300 py-2 px-5 ml-4 no-cursor'>Watch Later</button>
                            </div>
